...
function scene:createScene( event )
	...
	background = display.newImageRect( "end.jpg", display.contentWidth, display.contentHeight)
	...
	ej = display.newImageRect( "ej11.png", 620, 620 )
	ej.x = 492
	ej.y = 1300
	group:insert( ej )
