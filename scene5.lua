...
local optionText = {
	text = "В лесу он познакомился с птичками, бабочками и маленькой улиткой...",
	x = 680,
	y = 1400,
	width = 1300,
...
function scene:createScene( event )
	...
	background = display.newImageRect( "scene5.png", display.contentWidth, display.contentHeight)
