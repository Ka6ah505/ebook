...
local optionText = {
	text = "Вдруг он услышал чей-то вскрик:  - \"Ой-Ой!\". \"Кто это?\" - подумал Ёжик? А это оказался маленький Грибочек, которого Ёжик не заметил под листьями...",
	x = 680,
	y = 1300,
	width = 1300,
...
function scene:createScene( event )
	...
	background = display.newImageRect( "scene6.png", display.contentWidth, display.contentHeight)
